...
class ItemComponent extends Component {
    ...
    onChangePrice = (e) => {
        ...
        var actualDouble = parseFloat(result);
    ...
    isDiscounted(item) {
        if (item == "true") {
            return <i className="fa fa-check" aria-hidden="true" style={{ color: "#198754" }}></i>
        } else {
            return <i className="fa fa-times" aria-hidden="true" style={{ color: "#DC3545" }}></i>
        }
    }
    saveButton() {
    ...
    tbodyData() {
        ...
        if (this.state.selectedList === "regular") {
                    ...
                    this.state.itemsRegular.map(
                        item =>
                            <tr key={item.id} >
                                ...
                                <td><div style={tableMidStyle}>$ {item.actualPrice}</div></td>
                                <td>
            ...
            return <tbody>
                {
                    this.state.itemsDiscounted.map(
                        item =>
                            <tr key={item.id} >
                                <td><div style={tableLeftStyle}>{this.idBreak(item.id)}</div></td>
                                <td><div style={tableMidStyle}>{item.name}</div></td>
    ...
    totalBillPara() {
        ...
        var totalRegularBill = this.state.totalRegularBill;
        var totalDiscountedBill = this.state.totalDiscountedBill;
        if (this.state.selectedList === "all") {
            return totalBill;
    ...
    render() {
        ...
        return (
            <div className="col-sm min-vh-100">
                <div>
                    <nav className="navbar navbar-expand-lg navbar-dark " style={{ background: "#BBBFCA", position: "fixed", width: "82%" }}>
                        <div className="container-fluid">
                            ...
                            <div className="collapse navbar-collapse" id="navbarSupportedContent">
                                ...
                                <form className="d-flex">
                                    <button type="button" className="btn btn-warning d-flex" title='Add item' style={{}} onClick={this.openModal}>
                    ...
                    <div>
                        ...
                        <div className='row'>
                            ...
                            <div className='total-div'>
                                <p><b>Total Bill: </b>$ {this.totalBillPara()}</p>
                            </div>
                        </div>
